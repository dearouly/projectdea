            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Roya</h1>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-md-12 mb-0">NO HT</label>
                        <div class="col-md-12">
                            <input type="text" name="no_ht" 
                            class="form-control ps-0 form-control-line">
                        </div>
                </div>
 ...
 session_start();
        ...
        if (!empty($_FILES["myFile"])) {
          ...
          if (!$success) { 
            ...
            $insert = $conn->query("INSERT INTO roya(id_roya, username, nm_pemohon, nik, no_sertifikat, no_ht, jenis_sertif, alamat , tgl_upload, file_name, file_size, file_type, status)
            VALUES('$id_roya','$username', '$nm_pemohon' ,'$nik', '$no_sertifikat', '$no_ht', '$jenis_sertif', '$alamat', '$tgl', '$name', '$size', '$ext','$status')");

            if($insert){
              echo "<script>alert('Data Sukses Disimpan');window.location='roya.php'</script>";
            }else{
              echo "<script>alert('Data Gagal Disimpan, COBA LAGI');window.location='tambah_roya.php'</script>";
              exit;
            }
