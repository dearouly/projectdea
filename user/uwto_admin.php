...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>'.$row['user'].' </td>
            ...
            <td>
            <a href="edit_uwto.php?id_uwto='.$row['id_uwto'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
            <a href="hapus_uwto.php?id_uwto='.$row['id_uwto'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')"><i class="fa fa-times" aria-hidden="true"></i></a> 
            </td>
