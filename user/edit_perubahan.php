	...
	while($d = mysqli_fetch_array($data)){
        ...
        if($_POST['edit']){
            ...
            $username       = $_SESSION['username'];
              ...
              if($insert){
                echo "<script>alert('Data Sukses Diupdate');window.location='perubahan_admin.php'</script>";
              }else{
                echo "<script>alert('Data Gagal Diupdate');window.location='edit_perubahan.php'</script>";
              }
