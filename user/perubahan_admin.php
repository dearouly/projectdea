...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>
  <a href="edit_perubahan.php?id_ubah='.$row['id_ubah'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
  <a href="hapus_perubahan.php?id_ubah='.$row['id_ubah'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')" ><i class="fa fa-times" aria-hidden="true"></i></a> 
  </td>
