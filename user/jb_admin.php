...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>
  <a href="edit_jb.php?id_jb='.$row['id_jb'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
  <a href="hapus_jb.php?id_jb='.$row['id_jb'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')" ><i class="fa fa-times" aria-hidden="true"></i></a> 
  </td>
    </tr>
  ';
  $no++;
