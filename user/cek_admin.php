...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>
  <a href="edit_cek.php?id_cek='.$row['id_cek'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
  <a href="hapus_cek.php?id_cek='.$row['id_cek'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')"><i class="fa fa-times" aria-hidden="true"></i></a> 
  </td>
    </tr>
  ';
  $no++;
