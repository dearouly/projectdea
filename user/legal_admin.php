...
<body id="page-top">
    ...
    ?>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Legalisasi
                        <a href="cetak_legal.php"> 
...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>
  <a href="edit_legal.php?id_legal='.$row['id_legal'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
  <a href="hapus_legal.php?id_legal='.$row['id_legal'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')"><i class="fa fa-times" aria-hidden="true"></i></a> 
  </td>
    </tr>
  ';
  $no++;
