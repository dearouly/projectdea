...
<li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Warmeking</h1>
                    </div>
    ...
    <div class="modal-dialog" role="document">
      ...
      <a href="tambah_war.php" class="btn btn-primary"> <i class="fas fa-plus"></i> Tambah Permohonan </a>      
      </div>
    </div>
  </div>
</div>
...
<tr>
    ...
    <th>PEMBAYARAN</th>
     ...
     <?php
      $sql = $conn->query("SELECT * FROM warmerking WHERE username='{$_SESSION['username']}'");
      if($sql->num_rows > 0){
        $no = 1;
  ...
  data-toggle="tooltip" data-placement="top" title="'.$row['tgl_ubah'].'">'.$row['status'].'</a></td>
          ...
          <td> <a href="pembayaran2.php?id_war='.$row['id_war'].'" class="btn btn-warning btn-sm" >Lihat</a>  
          <a href="pembayaran_war.php?id_war='.$row['id_war'].'" class="btn btn-info btn-sm" >Tambah</a>  </td>
          </tr>
          ';
          $no++;
        }
