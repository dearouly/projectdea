...
<div class="modal fade" id="modalSaya" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <a href="tambah_ubah.php" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Permohonan </a>    
      </div>
    </div>
  </div>
</div>
...
<th>No</th>
    ...
    <th>PEMBAYARAN</th>
     ...
     <?php
      $sql = $conn->query("SELECT * FROM perubahan WHERE username='{$_SESSION['username']}'");
      if($sql->num_rows > 0){
        $no = 1;
