...
$username       = $_SESSION['username'];
              ...
              if($insert){
                echo "<script>alert('Data Sukses Diupdate');window.location='roya_admin.php'</script>";
              }else{
                echo "<script>alert('Data Gagal Diupdate');window.location='edit_roya.php'</script>";
              }
