	...
	while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                    <label class="col-md-12 mb-0">Nama</label>
                        <div class="col-md-12">
                            ...
                            class="form-control ps-0 form-control-line" required="required" >  
        ...
        if($_POST['edit']){
          ...
          $user  = $conn->real_escape_string($_POST['username']);
              ...
              $insert = $conn->query("UPDATE user SET nama='$nama', email='$email', username='$user' WHERE id=$id");
              if($insert){
                echo "<script>alert('Data Sukses Diupdate');window.location='staff.php'</script>";
              }else{
                echo "<script>alert('Data Gagal Diupdate');window.location='edit_staff.php'</script>";
              }
