            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Jual Beli</h1>
                    </div>
...
<div class="modal fade" id="modalSaya" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <?php 
		                        include '../koneksi.php';
                                $no = 1;
                                $data = mysqli_query($koneksi,"SELECT * FROM pelayanan WHERE id_pel = 'PPAT1';");
      ...
      <a href="tambah_jb.php" class="btn btn-primary"> <i class="fas fa-plus"></i> Tambah Permohonan </button></a>    
      </div>
    </div>
  </div>
</div>
...
<th>No</th>
    ...
    <th>PEMBAYARAN</th>
     ...
     <?php
      $sql = $conn->query("SELECT * FROM jual_beli WHERE username='{$_SESSION['username']}'");
      if($sql->num_rows > 0){
        $no = 1;
