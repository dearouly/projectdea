...
<body id="page-top">
	...
	while($d = mysqli_fetch_array($data)){
        ...
        $username       = $_SESSION['username'];
              ...
              if($insert){
                echo "<script>alert('Data Sukses Diupdate');window.location='legal_staff.php'</script>";
              }else{
                echo "<script>alert('Data Gagal Diupdate');window.location='edit_legal_staff.php'</script>";
              }
