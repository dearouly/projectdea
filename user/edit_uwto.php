	...
	while($d = mysqli_fetch_array($data)){
        ...
        if($_POST['edit']){
            ...
            $username       = $_SESSION['username'];
              ...
              if($insert){
                echo "<script>alert('Data Sukses Diupdate');window.location='uwto_admin.php'</script>";
              }else{
                echo "<script>alert('Data Gagal Diupdate');window.location='edit_uwto.php'</script>";
              }
