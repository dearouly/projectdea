...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>
  <a href="edit_roya.php?id_roya='.$row['id_roya'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
  <a href="hapus_roya.php?id_roya='.$row['id_roya'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')"><i class="fa fa-times" aria-hidden="true"></i></a> 
  </td>
    </tr>
  ';
  $no++;
