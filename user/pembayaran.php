        ...
        ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pembayaran
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                            <label class="col-md-12 mb-0">Jumlah</label>
						        <div class="col-sm-12">
							<input type="text" name="jumlah" value="<?php echo $d['jumlah']; ?>"class="form-control" onkeyup="convertToRupiah(this);" readonly value="">
						        </div>
					    </div>

                        <div class="form-group">
                    <label class="col-md-12 mb-0">Tgl Bayar</label>
                        <div class="col-md-12">
                            <input type="text" name="tgl_bayar" value="<?php echo $d['tgl_bayar']; ?>"
                            class="form-control ps-0 form-control-line" readonly value="">    
                        </div>
            </div>
