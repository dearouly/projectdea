			...
			if(strlen($password_baru) >= 5){
				...
				if($password_baru == $konfirmasi_password){
					...
					if($update){
						...
						echo "<script>alert('Password berhasil di ubah');window.location='profile_staff.php'</script>";;
					}else{
					...
					echo "<script>alert('Konfirmasi password tidak cocok');window.location='editprofile_staff.php'</script>";
				}
			}else{
				//kondisi jika password baru yang dimasukkan kurang dari 5 karakter
                echo "<script>alert('Minimal password baru adalah 5 karakter');window.location='editprofile_staff.php'</script>";
			}
		}else{
