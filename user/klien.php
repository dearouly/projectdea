        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h1 class="h3 mb-0 text-gray-800">DATA KLIEN</h1>
...
<br>
		...
		$no = 1;
        // WHERE level = 'NOT01';"
		$data = mysqli_query($koneksi,"select * from user WHERE level= 'klien'; ");
		while($d = mysqli_fetch_array($data)){
			?>
			<tr>
				<td><?php echo $no++; ?></td>
                <td>KLIEN<?php echo $d['id']; ?></td>
				<td><?php echo $d['nama']; ?></td>
				<td><?php echo $d['email']; ?></td>
				<td><?php echo $d['username']; ?></td>
                <td><?php echo $d['tgl_daftar']; ?></td>
				<td>
					<a href="hapus_klien.php?id=<?php echo $d['id']; ?>" onclick = "return confirm('Yakin ingin menghapus data ini?');" class="btn btn-danger btn-sm">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
