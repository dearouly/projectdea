		...
		if($cek->num_rows){
			...
			if(strlen($password_baru) >= 5){
				...
				if($password_baru == $konfirmasi_password){
					...
					echo "<script>alert('Konfirmasi password tidak cocok');window.location='edit_profile.php'</script>";
				}
			}else{
				//kondisi jika password baru yang dimasukkan kurang dari 5 karakter
                echo "<script>alert('Minimal password baru adalah 5 karakter');window.location='edit_profile.php'</script>";
			}
		}else{
