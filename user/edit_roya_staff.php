...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h1 class="h3 mb-0 text-gray-800">EDIT STATUS ROYA</h1>
                    <!-- Topbar Navbar -->
	...
	$data = mysqli_query($koneksi,"SELECT * from roya where id_roya='$id_roya'");
	while($d = mysqli_fetch_array($data)){
        ...
        <?php
        if($_POST['edit']){
            $id_roya = $_POST['id_roya'];
            $status = $_POST['status'];
            $tgl    = date("Y-m-d");
            $username       = $_SESSION['username'];

              $insert = $conn->query("UPDATE roya set status='$status', tgl_ubah='$tgl', user='$username' where id_roya='$id_roya'");
              if($insert){
                echo "<script>alert('Data Sukses Diupdate');window.location='roya_staff.php'</script>";
              }else{
                echo "<script>alert('Data Gagal Diupdate');window.location='edit_roya_staff.php'</script>";
              }    
            }
        ?>
        ...
        <div class="form-group">
                        <div class="col-md-12">
                        <input type="hidden" name="id_roya" value="<?php echo $d['id_roya']; ?>">
                        </div>
            </div> 
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-md-12 mb-0">NO HAK TANGGUNGAN</label>
                        <div class="col-md-12">
                            <input type="text" name="no_ht" value="<?php echo $d['no_ht']; ?>"
                            class="form-control ps-0 form-control-line" readonly value="" >    
                        </div>
            </div>   
