            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Pengecekan</h1>
                    </div>
 ...
 session_start();
        ...
        if (!empty($_FILES["myFile"])) {
          ...
          if ($myFile["error"] !== UPLOAD_ERR_OK) {
            echo "<script>alert('Data Gagal Disimpan, COBA LAGI');window.location='tambah_roya.php'</script>";
            exit;
          }
          ...
          $success = move_uploaded_file($myFile["tmp_name"],
            UPLOAD_DIR . $name);
          if (!$success) { 
            echo "<script>alert('Data Gagal Disimpan, COBA LAGI');window.location='tambah_cek.php'</script>";
            exit;
          }else{

    
            $insert = $conn->query("INSERT INTO pengecekan(id_cek, username, nm_pemohon, nik, no_sertifikat, jenis_sertif, alamat , tgl_upload, file_name, file_size, file_type, status)
            VALUES('$id_cek','$username', '$nm_pemohon' ,'$nik', '$no_sertifikat', '$jenis_sertif', '$alamat', '$tgl', '$name', '$size', '$ext', '$status')");

            if($insert){
              echo "<script>alert('Data Sukses Disimpan');window.location='pengecekan.php'</script>";
            }else{
              echo "<script>alert('Data Gagal Disimpan, COBA LAGI');window.location='tambah_cek.php'</script>";
              exit;
            }
