...
while ($row = mysqli_fetch_array($query)){
  ...
  <td>
  <a href="edit_diri.php?id_diri='.$row['id_diri'].'" class="btn"><i class="fas fa-pencil-alt"></i></a> 
  <a href="hapus_diri.php?id_diri='.$row['id_diri'].'" class="btn" onclick="return confirm(\'Yakin ingin menghapus data ini?\')" ><i class="fa fa-times" aria-hidden="true"></i></a> 
  </td>
    </tr>
  ';
  $no++;
